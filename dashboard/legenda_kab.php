...

{
    ...
    if ($kd_indi == 17) {
        ...
        echo '<div class="container-fluid mt-3 text-center">&nbsp;&nbsp;<span class="badge bg-primary" style="color: #ffffff;">CAPAIAN > 75</span>&nbsp;&nbsp;<span class="badge bg-success" style="color: #ffffff;">70 ≤ CAPAIAN ≤ 75</span>&nbsp;&nbsp;<span class="badge bg-warning" style="color: #000000;">65 ≤ CAPAIAN < 70 </span>&nbsp;&nbsp;<span class="badge bg-danger" style="color: #ffffff;">CAPAIAN < 65</span></div>
        </div>
        ';
    }
