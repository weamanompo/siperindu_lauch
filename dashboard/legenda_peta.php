...

{
    ...
    if ($kd_indi == 9) {
        ...
        echo '<div class="container-fluid mt-3 text-center">&nbsp;&nbsp;<span class="badge bg-primary" style="color: #ffffff;">NORMAL : 2,0 ≤ CAPAIAN ≤ 2,19</span>&nbsp;&nbsp;<span class="badge bg-success" style="color: #ffffff;">WASPADA : 2.2 ≤ CAPAIAN ≤ 2,39 ATAU 1,8 ≤ CAPAIAN ≤ 1,99</span>&nbsp;&nbsp;<span class="badge bg-warning" style="color: #000000;">SIAGA : 2.4 ≤ CAPAIAN ≤ 2,69 ATAU CAPAIAN < 1,8</span>&nbsp;&nbsp;<span class="badge bg-danger" style="color: #ffffff;">AWAS : CAPAIAN ≥ 2,7</span>&nbsp;&nbsp;<span class="badge bg-secondary style="color: #ffffff;">BELUM ADA DATA</span></div>
        </div>
        ';
    }
