...
$cekkiri = mysqli_query($koneksi, "SELECT * FROM transaksi_pilar WHERE CHAR_LENGTH(kode_wilayah)=2 AND tahun_indi_pilar < $tahun AND kd_indi_pilar= '$kd_indi' ");
...
$cekdata = mysqli_query($koneksi, "SELECT * FROM transaksi_pilar WHERE kd_indi_pilar = '$kd_indi' AND CHAR_LENGTH(kode_wilayah)=2 ");
...
<?php if ($kd_indi != 4 && $recekpanah != 0) : ?>
    ...
    <?php if ($n == 0) : ?>
        <div class="container-fluid text-center">Data capaian nasional belum tersedia</div>
    <?php endif; ?>
    <?php if ($n != 0) : ?>
...
<?php if ($kd_indi == 4 && $recekpanah != 0) : ?>
    ...
    :#13005A;">
        <a href="#indikator"><img src="../assets/img/kiri.png" width="2.5%" id="kiri_peta"></a>
        &nbsp;&nbsp;PETA &nbsp;&nbsp;<span id="subjudul_indi" style="color :chocolate;"><?= strtoupper($namaindi); ?></span>&nbsp;&nbsp;SETIAP PROVINSI
    </h5>
    <?php if ($n == 0) : ?>
        <div class="container-fluid text-center">Data capaian nasional belum tersedia</div>
    <?php endif; ?>
...
<div class="container-fluid text-center">
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="90%" height="90%" viewBox="0 0 1123 435">
        <defs>
            <style>
                .cls-1 {
        ...
        $n = mysqli_fetch_assoc($nilai)['nilai_indi_pilar'];
        ?>
        <a xlink:href="#1" class="hover" id="<?php hitung($kdwil, $kd_indi, $n); ?>" onclick="edit_user(<?php hitung($kdwil, $kd_indi, $n); ?>)">
            <?php warnakab($n, $kd_indi, $kdwil); ?>
