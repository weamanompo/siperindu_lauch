...
<?php if ($kon == 4) : ?>
    <div class="card">
        ...
        <div class="card-body">
            <h5 class="card-title text-center"><span style="color: #862B0D ;"><?= strtoupper($nm['nama_indi_pilar']); ?></span> : <span class="badge bg-danger"><?= $n; ?></span></h5>
...
<?php if ($kon == 3) : ?>
    <div class="card">
        ...
        <div class="card-body">
            <h5 class="card-title text-center"><span style="color: #862B0D ;"><?= strtoupper($nm['nama_indi_pilar']); ?></span> : <span class="badge bg-warning"><?= $n; ?></span></h5>
...
<?php if ($kon  == 2) : ?>
    <div class="card">
        ...
        <div class="card-body">
            <h5 class="card-title text-center"><span style="color: #862B0D ;"><?= strtoupper($nm['nama_indi_pilar']); ?></span> : <span class="badge bg-success"><?= $n; ?></span></h5>
            <h5 class="card-title">Peringatan :</h5>
            <p class="card-text">
...
<?php if ($kon  == 1) : ?>
    <div class="card">
        ...
        <div class="card-body">
            <h5 class="card-title text-center"><span style="color: #862B0D ;"><?= strtoupper($nm['nama_indi_pilar']); ?></span> : <span class="badge bg-primary"><?= $n; ?></span></h5>
            <h5 class="card-title">Peringatan :</h5>
            <p class="card-text">
