...
$cekthn = mysqli_query($koneksi, "SELECT * FROM indikator_nav WHERE CHAR_LENGTH(kode_wilayah_nav) = 2 AND  kode_indikator_nav = '$kd_indi' AND tahun_nav < $tahun_mak ORDER BY tahun_nav DESC LIMIT 1");
