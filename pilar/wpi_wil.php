...
while ($ap = mysqli_fetch_assoc($pilar)) {
  ...
  while ($di = mysqli_fetch_assoc($ambilindi)) {
    ...
    $amnilai = mysqli_query($koneksi, "SELECT * FROM transaksi_pilar WHERE kode_wilayah = '$kdwil' AND kd_indi_pilar = '$kdindina' AND tahun_indi_pilar = '$tahun_besar'");
          ...
          <div class="container-fluid">
            <div id="isi">
              ...
              <?php if ($jts == 2) : ?>
                ...
                <h4 class="mt-1 mb-4">CAPAIAN INDIKATOR <span style="color :chocolate;">PROVINSI <?= $nmprov; ?></span></h4>
              ...
              <?php if ($jts == 5) : ?>
                ...
                $pemisah = mysqli_fetch_assoc($prov)['nama'];
                ...
                <h4 class="mt-1 mb-4">CAPAIAN INDIKATOR <span style="color :chocolate;"><?= strtoupper($ase); ?></span></h4>
