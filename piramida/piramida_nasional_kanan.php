...
$cekkecil = mysqli_query($koneksi, "SELECT * FROM piramida WHERE kd_wilayah = '1' ORDER BY tahun DESC");

$tabesar = mysqli_fetch_assoc($cekkecil)['tahun'];

?>
<?php if ($tabesar == $tgl) : ?>
    <h5 id="judul_indi" class="card-title text-center mt-4" style="color
    :#13005A;"><img style="cursor:pointer" src="../assets/img/kiri.png" width="2.5%" id="kiri_peta">&nbsp;&nbsp;
        PIRAMIDA PENDUDUK NASIONAL&nbsp;&nbsp;
    </h5>
<?php endif; ?>
    ...
    var options = {
        series: [{
                ...
                data: [
                    ...
                    $pddk21 = mysqli_query($koneksi, "SELECT *  FROM piramida WHERE kd_wilayah = '1' AND tahun = '$tgl'");
            ...
            },
            {
                ...
                data: [
                    ...
                    $pddk1 = mysqli_query($koneksi, "SELECT * FROM piramida WHERE kd_wilayah = '1' AND tahun = '$tgl'");
