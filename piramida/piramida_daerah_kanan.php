...
$cekkecil = mysqli_query($koneksi, "SELECT * FROM piramida WHERE kd_wilayah = '$kdwil' ORDER BY tahun DESC");

$tabesar = mysqli_fetch_assoc($cekkecil)['tahun'];

$prov = mysqli_query($koneksi, "SELECT * FROM wilayah_2022 WHERE kode = '$kdwil'");

$aseng = mysqli_fetch_assoc($prov)['nama'];
...
<?php if ($acek != 0 && $jl == 2) : ?>
    ...
    :#13005A;"><img style="cursor:pointer" src="../assets/img/kiri.png" width="2%" id="kiri_peta">
            &nbsp;&nbsp;PIRAMIDA PENDUDUK PROVINSI&nbsp;<?= $aseng; ?>
        </h5>
    <?php endif; ?>
    <?php if ($tgl != $tabesar) : ?>
        <h5 id="judul_indi" class="card-title text-center mt-1" style="color
    :#13005A;">
            <a href="#indikator"><img src="../assets/img/kiri.png" width="2%" id="kiri_peta"></a>&nbsp;
            PIRAMIDA PENDUDUK PROVINSI&nbsp;<?= $aseng; ?>&nbsp;&nbsp;<img style="cursor:pointer" src="../assets/img/kanan.png" width="2.5%" id="kanan_peta">
        </h5>
    <?php endif; ?>
<?php endif; ?>
...
<?php if ($acek != 0 && $jl == 5) : ?>
    <?php if ($tgl == $tabesar) : ?>
        <h5 id="judul_indi" class="card-title text-center mt-1" style="color
    :#13005A;">&nbsp;&nbsp;<img style="cursor:pointer" src="../assets/img/kiri.png" width="2%" id="kiri_peta_kab">
            PIRAMIDA PENDUDUK &nbsp;<?= $aseng; ?>
        </h5>
    <?php endif; ?>
    <?php if ($tgl != $tabesar) : ?>
        <h5 id="judul_indi" class="card-title text-center mt-1" style="color
    :#13005A;">
            <a href="#indikator"><img src="../assets/img/kiri.png" width="2%" id="kiri_peta_kab"></a>&nbsp;
            PIRAMIDA PENDUDUK &nbsp;<?= $aseng; ?>&nbsp;&nbsp;<img style="cursor:pointer" src="../assets/img/kanan.png" width="2.5%" id="kanan_peta_kab">
        </h5>
    <?php endif; ?>
<?php endif; ?>

<input type="text" id="tahun" value="<?= $tgl; ?>" hidden>
<input type="text" id="provinsi" value="<?= $kdwil; ?>" hidden>
<div id="chart">
</div>
<script>
    var options = {
...
<script>
    $(document).ready(function() {
        $("#kiri_peta_kab").on('click', function() {
            var tahun = $("#tahun").val();
...
<script>
    $(document).ready(function() {
        $("#kanan_peta_kab").on('click', function() {
            var tahun = $("#tahun").val();
            var provinsi = $("#form_kab").val();
            $(".loader").show();
            $.ajax({
